# 🔥 MediaCrawler - 微博数据爬虫 🕷️

> **⚠️ 重要说明**: 此版本已简化为仅支持微博平台。完整的多平台版本请访问 [原项目地址](https://github.com/NanmiCoder/MediaCrawler)
> 
> 详细使用说明请查看: [README_WEIBO_ONLY.md](README_WEIBO_ONLY.md)
